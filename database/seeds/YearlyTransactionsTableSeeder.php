...
class YearlyTransactionsTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        for ($i = 0; $i < count($dates); $i++) {
            $firstday[$i] = Carbon::createFromFormat('Y-m-d', $dates[$i])->startOfYear();
            $lastday[$i] = Carbon::createFromFormat('Y-m-d', $dates[$i])->endOfYear();
